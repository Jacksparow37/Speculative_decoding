...
# def draft_model_process(model_name, gpu_index, draft_id, prompts, host='localhost', port=5000, num_speculative_tokens=3, temperature=1.0):
...
# def primal_model_process(model_name, gpu_index, output_queue, host='localhost', port=5000, num_speculative_tokens=3, temperature=1.0):
...
#                 # Generate one additional token to complete the output
